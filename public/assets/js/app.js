...
const App = function () {
    ...
    const initActiveMenu = function () {
        ...
        if (currentPath) {
            ...
            if (navbarNav) {
                var a = navbarNav.querySelector('[href="' + currentPath + '"]');
                if (a) {
                    ...
                    console.warn('Anchor element not found for href="' + currentPath + '"');
                }
            } else {
                console.warn('Element with id "navbar-nav" not found');
            }
        }
    }
