...
class CreateTheme1 extends CreateElement
{
    ...
    protected function generateTHEMEELEMENTS()
    {
        $this->_xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':themeElements>__PHX=__GENERATETHEMEELEMENTS1____PHX=__' .
                'GENERATETHEMEELEMENTS2____PHX=__GENERATETHEMEELEMENTS3__</' .
                CreateTheme1::NAMESPACEWORD .
                ':themeElements>__PHX=__GENERATETHEMEELEMENTS4__';
    }
    ...
    protected function generateCLRSCHEME($name = 'Office')
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':clrScheme name="' . $name .
                '">__PHX=__GENERATECLRSCHEME__</' . CreateTheme1::NAMESPACEWORD .
                ':clrScheme>';

        $this->_xml = str_replace(
                '__PHX=__GENERATETHEMEELEMENTS1__', $xml, $this->_xml
        );
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':dk1>__PHX=__GENERATESYSCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':dk1>__PHX=__GENERATEDK1__';

        $this->_xml = str_replace('__PHX=__GENERATECLRSCHEME__', $xml, $this->_xml);
    }
    ...
    protected function generateSYSCLR($val = 'windowText', $lastClr = '000000')
    {
        ...
        $this->_xml = str_replace('__PHX=__GENERATESYSCLR__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':lt1>__PHX=__GENERATESYSCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':lt1>__PHX=__GENERATELT1__';
        $this->_xml = str_replace('__PHX=__GENERATEDK1__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':dk2>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':dk2>__PHX=__GENERATEDK2__';
        $this->_xml = str_replace('__PHX=__GENERATELT1__', $xml, $this->_xml);
    }
    ...
    protected function generateSRGBCLR($val = 'windowText')
    {
        ...
        $this->_xml = str_replace('__PHX=__GENERATESRGBCLR__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':lt2>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':lt2>__PHX=__GENERATELT2__';
        $this->_xml = str_replace('__PHX=__GENERATEDK2__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':accent1>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':accent1>__PHX=__GENERATEACCENT1__';
        $this->_xml = str_replace('__PHX=__GENERATELT2__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':accent2>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':accent2>__PHX=__GENERATEACCENT2__';
        $this->_xml = str_replace('__PHX=__GENERATEACCENT1__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':accent3>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':accent3>__PHX=__GENERATEACCENT3__';
        $this->_xml = str_replace('__PHX=__GENERATEACCENT2__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':accent4>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':accent4>__PHX=__GENERATEACCENT4__';
        $this->_xml = str_replace('__PHX=__GENERATEACCENT3__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':accent5>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':accent5>__PHX=__GENERATEACCENT5__';
        $this->_xml = str_replace('__PHX=__GENERATEACCENT4__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':accent6>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':accent6>__PHX=__GENERATEACCENT6__';
        $this->_xml = str_replace('__PHX=__GENERATEACCENT5__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':hlink>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':hlink>__PHX=__GENERATEHLINK__';
        $this->_xml = str_replace('__PHX=__GENERATEACCENT6__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':folHlink>__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':folHlink>';
        $this->_xml = str_replace('__PHX=__GENERATEHLINK__', $xml, $this->_xml);
    }
    ...
    protected function generateFONTSCHEMA($name = 'Office')
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                '">__PHX=__GENERATEFONTSCHEMA1____PHX=__GENERATEFONTSCHEMA2__</' .
                CreateTheme1::NAMESPACEWORD . ':fontScheme>';

        $this->_xml = str_replace(
                '__PHX=__GENERATETHEMEELEMENTS2__', $xml, $this->_xml
        );
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':majorFont>__PHX=__GENERATEMAYORFONT__</' .
                CreateTheme1::NAMESPACEWORD .
                ':majorFont>';

        $this->_xml = str_replace('__PHX=__GENERATEFONTSCHEMA1__', $xml, $this->_xml);
    }
    ...
    protected function generateLATIN($typeface = 'cambia')
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                '"></' . CreateTheme1::NAMESPACEWORD .
                ':latin>__PHX=__GENERATELATIN__';

        $this->_xml = str_replace('__PHX=__GENERATEMAYORFONT__', $xml, $this->_xml);
    }
    ...
    protected function generateEA($typeface = '')
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                '"></' . CreateTheme1::NAMESPACEWORD .
                ':ea>__PHX=__GENERATEEA__';
        $this->_xml = str_replace('__PHX=__GENERATELATIN__', $xml, $this->_xml);
    }
    ...
    protected function generateCS($typeface = '')
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                '"></' . CreateTheme1::NAMESPACEWORD .
                ':cs>__PHX=__GENERATECS__';

        $this->_xml = str_replace('__PHX=__GENERATEEA__', $xml, $this->_xml);
    }
    ...
    protected function generateFONT($script = '', $typeface = '')
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                '" typeface="' . $typeface .
                '"></' . CreateTheme1::NAMESPACEWORD .
                ':font>__PHX=__GENERATEFONT__';
        $this->_xml = str_replace('__PHX=__GENERATECS__', $xml, $this->_xml);
    }
    ...
    protected function generateFONT2($script = '', $typeface = '')
    {
        ...
        $this->_xml = str_replace('__PHX=__GENERATEFONT__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':minorFont>__PHX=__GENERATEMAYORFONT__</' .
                CreateTheme1::NAMESPACEWORD . ':minorFont>';
        $this->_xml = str_replace('__PHX=__GENERATEFONTSCHEMA2__', $xml, $this->_xml);
    }
    ...
    protected function generateFMTSCHEME($name)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':fmtScheme name="' . $name .
                '">__PHX=__GENERATEFMTSCHEME__</' . CreateTheme1::NAMESPACEWORD .
                ':fmtScheme>';
        $this->_xml = str_replace(
                '__PHX=__GENERATETHEMEELEMENTS3__', $xml, $this->_xml
        );
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':fillStyleLst>__PHX=__GENERATEFILLSTYLELST__</' .
                CreateTheme1::NAMESPACEWORD .
                ':fillStyleLst>__PHX=__GENERATEFILLSTYLELST2__';
        $this->_xml = str_replace('__PHX=__GENERATEFMTSCHEME__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':solidFill>__PHX=__GENERATESOLIDFILL__</' .
                CreateTheme1::NAMESPACEWORD .
                ':solidFill>__PHX=__GENERATESOLIDFILL2__';

        $this->_xml = str_replace(
                '__PHX=__GENERATEFILLSTYLELST__', $xml, $this->_xml
        );
    }
     ...
     *
     * @access protected
     * @param mixed $rotWithShape
     */
    protected function generateGRADFILL($rotWithShape)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':gradFill rotWithShape="' .
                $rotWithShape . '">__PHX=__GENERATEGRADFILL__</' .
                CreateTheme1::NAMESPACEWORD .
                ':gradFill>__PHX=__GENERATESOLIDFILL2__';

        $this->_xml = str_replace('__PHX=__GENERATESOLIDFILL2__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':gsLst>__PHX=__GENERATEGSLST__</' .
                CreateTheme1::NAMESPACEWORD . ':gsLst>__PHX=__GENERATEGSLST2__';
        $this->_xml = str_replace('__PHX=__GENERATEGRADFILL__', $xml, $this->_xml);
    }
    ...
    protected function generateGS($pos)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':gs pos="' . $pos .
                '">__PHX=__GENERATEPOS__</' . CreateTheme1::NAMESPACEWORD .
                ':gs>__PHX=__GENERATEGSLST__';
        $this->_xml = str_replace('__PHX=__GENERATEGSLST__', $xml, $this->_xml);
    }
    ...
    protected function generateGS2($pos)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':gs pos="' .
                $pos . '">__PHX=__GENERATEPOS__</' . CreateTheme1::NAMESPACEWORD . ':gs>';
        $this->_xml = str_replace('__PHX=__GENERATEGSLST__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':schemeClr val="' . $val .
                '">__PHX=__GENERATESCHEMECLR2__</' . CreateTheme1::NAMESPACEWORD .
                ':schemeClr>';
        $this->_xml = str_replace('__PHX=__GENERATEPOS__', $xml, $this->_xml);
    }
    ...
    protected function generateTINT($val)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':tint val="' . $val .
                '"></' . CreateTheme1::NAMESPACEWORD .
                ':tint>__PHX=__GENERATETINT__';
        $this->_xml = str_replace('__PHX=__GENERATESCHEMECLR2__', $xml, $this->_xml);
    }
    ...
    protected function generateSHADE($val)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':shade val="' . $val .
                '"></' . CreateTheme1::NAMESPACEWORD . ':shade>__PHX=__GENERATETINT__';
        $this->_xml = str_replace('__PHX=__GENERATESCHEMECLR2__', $xml, $this->_xml);
    }
    ...
    protected function generateSATMOD($val)
    {
        ...
        $this->_xml = str_replace('__PHX=__GENERATETINT__', $xml, $this->_xml);
    }
    ...
    protected function generateLIN($ang, $scaled)
    {
        ...
        $this->_xml = str_replace('__PHX=__GENERATEGSLST2__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':lnStyleLst>__PHX=__GENERATELNSTYLELST__</' .
                CreateTheme1::NAMESPACEWORD . ':lnStyleLst>__PHX=__GENERATELNSTYLELST2__';
        $this->_xml = str_replace(
                '__PHX=__GENERATEFILLSTYLELST2__', $xml, $this->_xml
        );
    }
    ...
    protected function generateLN($w = null, $cap = null, $cmpd = null, $algn = null)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':ln w="' . $w .
                ...
                '">__PHX=__GENERATEFILLSTYLELST__</' . CreateTheme1::NAMESPACEWORD .
                ':ln>__PHX=__GENERATELNSTYLELST__';
        $this->_xml = str_replace('__PHX=__GENERATELNSTYLELST__', $xml, $this->_xml);
    }
    ...
    protected function generateSCHEMECLR3($val)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':schemeClr val="' .
                $val . '">__PHX=__GENERATESCHEMECLR2__</' . CreateTheme1::NAMESPACEWORD
                . ':schemeClr>';
        $this->_xml = str_replace('__PHX=__GENERATESOLIDFILL__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':effectStyleLst>__PHX=__GENERATEEFFECTSTYLELST__</' .
                CreateTheme1::NAMESPACEWORD .
                ':effectStyleLst>__PHX=__GENERATEEFFECTSTYLELST2__';
        $this->_xml = str_replace('__PHX=__GENERATELNSTYLELST2__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':effectStyle>__PHX=__GENERATEEFFECTSTYLE__</' .
                CreateTheme1::NAMESPACEWORD .
                ':effectStyle>__PHX=__GENERATEEFFECTSTYLELST__';
        $this->_xml = str_replace(
                '__PHX=__GENERATEEFFECTSTYLELST__', $xml, $this->_xml
        );
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':effectLst>__PHX=__GENERATEEFFECTLST__</' .
                CreateTheme1::NAMESPACEWORD . ':effectLst>';
        $this->_xml = str_replace('__PHX=__GENERATEEFFECTSTYLE__', $xml, $this->_xml);
    }
    ...
    protected function generateOUTERSHDW($blurRad, $dist, $dir, $rotWithShape)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                $rotWithShape . '">__PHX=__GENERATEOUTERSHDW__</' .
                CreateTheme1::NAMESPACEWORD . ':outerShdw>';
        $this->_xml = str_replace('__PHX=__GENERATEEFFECTLST__', $xml, $this->_xml);
    }
    ...
    protected function generateSRGBCLR2($val)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':srgbClr val="' .
                $val . '">__PHX=__GENERATESRGBCLR__</' . CreateTheme1::NAMESPACEWORD .
                ':srgbClr>';
        $this->_xml = str_replace('__PHX=__GENERATEOUTERSHDW__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':effectLst>__PHX=__GENERATEEFFECTLST__</' . CreateTheme1::NAMESPACEWORD .
                ':effectLst>__PHX=__GENERATEEFFECTLST2__';
        $this->_xml = str_replace('__PHX=__GENERATEEFFECTSTYLE__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':scene3d>__PHX=__GENERATESCENE3D__</' . CreateTheme1::NAMESPACEWORD .
                ':scene3d>__PHX=__GENERATESCENE3D2__';
        $this->_xml = str_replace('__PHX=__GENERATEEFFECTLST2__', $xml, $this->_xml);
    }
    ...
    protected function generateCAMERA($prst)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':camera prst="' . $prst .
                '">__PHX=__GENERATECAMERA__</' . CreateTheme1::NAMESPACEWORD .
                ':camera>__PHX=__GENERATECAMERA2__';
        $this->_xml = str_replace('__PHX=__GENERATESCENE3D__', $xml, $this->_xml);
    }
    ...
    protected function generateROT($lat, $lon, $rev)
    {
        ...
        $this->_xml = str_replace('__PHX=__GENERATECAMERA__', $xml, $this->_xml);
    }
    ...
    protected function generateLIGHTRIG($rig, $dir)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                '">__PHX=__GENERATECAMERA__</' . CreateTheme1::NAMESPACEWORD .
                ':lightRig>';
        $this->_xml = str_replace('__PHX=__GENERATECAMERA2__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':sp3d>__PHX=__GENERATESP3D__</' . CreateTheme1::NAMESPACEWORD .
                ':sp3d>';
        $this->_xml = str_replace('__PHX=__GENERATESCENE3D2__', $xml, $this->_xml);
    }
    ...
    protected function generateBEVELT($w, $h)
    {
        ...
        $this->_xml = str_replace('__PHX=__GENERATESP3D__', $xml, $this->_xml);
    }
    ...
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':bgFillStyleLst>__PHX=__GENERATEFILLSTYLELST__</' .
                CreateTheme1::NAMESPACEWORD . ':bgFillStyleLst>';

        $this->_xml = str_replace(
                '__PHX=__GENERATEEFFECTSTYLELST2__', $xml, $this->_xml
        );
    }
    ...
    protected function generateTINT2($val)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD . ':tint val="' . $val .
                '"></' . CreateTheme1::NAMESPACEWORD .
                ':tint>__PHX=__GENERATESCHEMECLR2__';
        $this->_xml = str_replace('__PHX=__GENERATESCHEMECLR2__', $xml, $this->_xml);
    }
    ...
    protected function generatePATH($path)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ':path path="' . $path .
                '">__PHX=__GENERATEPATH__</' . CreateTheme1::NAMESPACEWORD .
                ':path>';
        $this->_xml = str_replace('__PHX=__GENERATEGSLST2__', $xml, $this->_xml);
    }
    ...
    protected function generateFILLTORECT($l, $t, $r, $b)
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                ':fillToRect>';
        $this->_xml = str_replace('__PHX=__GENERATEPATH__', $xml, $this->_xml);
    }
    ...
    protected function generateOBJECTDEFAULTS()
    {
        $xml = '<' . CreateTheme1::NAMESPACEWORD .
                ...
                ':objectDefaults>__PHX=__GENERATETHEMEELEMENTS4__';

        $this->_xml = str_replace(
                '__PHX=__GENERATETHEMEELEMENTS4__', $xml, $this->_xml
        );
    }
