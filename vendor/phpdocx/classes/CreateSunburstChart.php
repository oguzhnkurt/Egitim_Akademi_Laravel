 ...
 */
class CreateSunburstChart extends CreateGraphicEx
{
    /**
     * Create XML chart
     *
    ...
    public function createChartEx($rId, $options)
    {
        ...
        // chart
        $xmlChart .= '<cx:chart><cx:title align="ctr" overlay="0" pos="t">'.$titleContent.'</cx:title><cx:plotArea><cx:plotAreaRegion><cx:series layoutId="sunburst"><cx:tx><cx:txData><cx:f>Sheet1!$D$1</cx:f><cx:v>'.$seriesName.'</cx:v></cx:txData></cx:tx><cx:dataLabels pos="ctr"><cx:visibility categoryName="1" seriesName="0" value="0"/></cx:dataLabels><cx:dataId val="0"/></cx:series></cx:plotAreaRegion></cx:plotArea>'.$legendContent.'</cx:chart>';
