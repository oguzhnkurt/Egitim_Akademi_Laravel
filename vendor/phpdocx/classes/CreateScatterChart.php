    ...
    public function createEmbeddedXmlChart()
    {
        ...
        foreach ($seriesNumPt as $seriesNumPtIndex => $seriesNumPtCount) {
            ...
            if (is_array($this->_theme) && isset($this->_theme['serDataLabels'])) {
                if ($this->_theme['serDataLabels'][$seriesNumPtIndex] != null) {
                    $this->generateDATALABELS_SER($this->_theme['serDataLabels'][$seriesNumPtIndex], $seriesNumPtIndex);
                }
            }

            if (is_array($this->_theme) && isset($this->_theme['valueDataLabels'])) {
                if (isset($this->_theme['valueDataLabels'][$seriesNumPtIndex]) && $this->_theme['valueDataLabels'][$seriesNumPtIndex] != null) {
                    $this->generateDATALABELS_DLBL($this->_theme['valueDataLabels'][$seriesNumPtIndex], $seriesNumPtIndex);
                }
            }
