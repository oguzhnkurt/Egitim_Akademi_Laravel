...
class CreateChartRels extends CreateElement
{
     ...
     * @access public
     * @param int $idChart
     * @param bool $embedXlsx
     */
    public function createRelationship($idChart, $embedXlsx = true)
    {
    ...
    protected function generateRELATIONSHIP($idChart, $id = 1)
    {
        $xml = '<Relationship Id="rId' . $id . '" Type="http://schemas.open'
                ...
                . '.xlsx"></Relationship>__PHX=__GENERATECHARTSPACE__';

        $tag = '__PHX=__GENERATERELATIONSHIPS__';
    ...
    protected function generateRELATIONSHIPS()
    {
        $this->_xml = '<?xml version="1.0" encoding="UTF-8" standalone="yes" ?>'
                ...
                . 'package/2006/relationships">__PHX=__GENERATERELATIONSHIPS__'
                . '</Relationships>';
    }
