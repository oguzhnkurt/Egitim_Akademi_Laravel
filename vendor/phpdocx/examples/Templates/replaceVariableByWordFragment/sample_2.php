<?php
// replace a text variable (placeholder) with a WordFragment in footnotes from an existing DOCX
...
// insert all content in the Word fragment we are going to use for replacement
$wf->addText($text);
