<?php
// replace a text variable (placeholder) with a WordFragment from an existing DOCX

require_once '../../../classes/CreateDocx.php';

$docx = new CreateDocxFromTemplate('../../files/TemplateWordFragment_1_symbols.docx');
...
$link->addLink('link to Google', array('url'=> 'http://www.google.com', 'color' => '0000FF', 'u' => 'single'));
...
$docx->createDocx('example_replaceVariableByWordFragment_6');