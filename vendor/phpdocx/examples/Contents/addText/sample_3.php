<?php
// add a text that includes contents as an array
...
// insert the different runs of text with created content and some text
$text = array();
...
$text[] = $footnote;
$text[] = array(
    'text' => ' , as you may check there is a footnote at the bottom of the page. ',
    'color' => 'B70000'
);
